...
// each add a single canonical FilterCondition to the active filter. If the
// canonical condition already exists in state, the button shows
// "Added ✓" and is disabled.
...
// Chip set per Billy's 2026-05-27 feedback. Toggle behavior:
